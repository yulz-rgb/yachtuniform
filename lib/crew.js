...
const VALID_ROLES = new Set([
  'captain', 'chief-stew', 'interior', 'deck', 'chef', 'engineer',
]);
...
export function normalizeCrewMember(member = {}, lookNameToId = new Map()) {
  ...
  return {
    ...
    role: VALID_ROLES.has(member.role) ? member.role : 'interior',
