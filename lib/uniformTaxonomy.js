...
export const navCategories = [
  ...
  { id: 'bridge', section: 'department', label: 'Bridge', departments: ['captain', 'boss'], subFilters: ['All', 'Epaulette Shirts', 'Officer Shirts', 'Shirts', 'Trousers', 'Knitwear', 'Blazers', 'Ties'] },
  { id: 'deck', section: 'department', label: 'Deck', departments: ['deck'], subFilters: ['All', 'Polos', 'T-Shirts', 'Shorts', 'Trousers', 'Knitwear', 'Softshell', 'Jackets', 'Fleece', 'Vests', 'Foul Weather'] },
  ...
  { id: 'interior', section: 'department', label: 'Interior', departments: ['interior', 'chief-stew'], subFilters: ['All', 'Dresses', 'Skorts', 'Blouses', 'Dress Shirts', 'Polos', 'T-Shirts', 'Shorts', 'Trousers', 'Knitwear', 'Softshell', 'Jackets', 'Fleece', 'Vests', 'Foul Weather', 'Blazers'] },
  { id: 'galley', section: 'department', label: 'Galley', departments: ['chef'], subFilters: ['All', 'Jackets', 'Shirts', 'Tunics', 'Trousers', 'Aprons', 'Shoes'] },
